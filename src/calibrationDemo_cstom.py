...
baseDir = 'custom' #data directory
objName = 'box9' #object name (should correspond to a dir in data)
seqName = 'v1' #sequence name (subdirectory of object)
calName = 'calib3' #calibration sourse (also a dir in data)
...
firstFrame = os.path.join(baseDir, objName, 'frame_2877.jpg')
